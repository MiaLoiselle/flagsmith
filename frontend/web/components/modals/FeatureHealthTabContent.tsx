...
const EventTextBlocks = ({
  ...
  const initialValue =
    textBlocks?.map((_, index) => ({ collapsed: true, id: index })) ?? []
  ...
  return (
    <div className='d-flex flex-column m-0 gap-2'>
  ...
  return (
    <div>
      <Tooltip
        title={
          <h5 className='mb-4'>
            Unhealthy Events <Icon name='info-outlined' />
          </h5>
        }
        place='top'
      >
          ...
          >
            <div className='d-flex justify-content-between align-items-center mb-4'>
              <div className='d-flex align-items-center'>
                <IonIcon
                  style={{ color: Constants.tagColors[16], marginBottom: -2 }}
                  className='ms-1 mr-1'
                  icon={warning}
                />
